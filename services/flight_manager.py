...
def book_flight(flight_id: int, seat_type: str, num_seats: int = 1):
    """
    Sends a POST request to a FastAPI endpoint to book a flight based on various parameters
    ...
    url = f"http://127.0.0.1:8000/book_flight?flight_id={flight_id}&seat_type={seat_type}&num_seats={num_seats}"
